...
use typed_jni::{
    DynArg, LocalClass, LocalObject, Type, TypedCallExt, TypedClassExt, TypedFieldAccessExt, TypedStringExt, core::JavaVM,
    define_java_class,
};
...
fn main() {
    ...
    let vm = unsafe { JavaVM::from_raw(vm.get_java_vm_pointer() as _) };

    vm.with_attached_thread(false, |env| {
